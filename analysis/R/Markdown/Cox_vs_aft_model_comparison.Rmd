...
```{r table2, echo = FALSE, warning= FALSE, message= FALSE, results='asis', fig.cap="Table 3: Parameter estimates and 95% confidence interval from the different models", fig.align = 'center'}
# Cox
...
colnames(results) <- c("Variable", 
                       "Stratified CoxPH",
                       "Weibull AFT model", "Weibull AFT model (with random effects)",
                       "Exponential AFT model", "Exponential AFT model (with random effects)",
                       "Log-logistic AFT model", "Log-logistic AFT model (with random effects)",
                       "Log-normal AFT model", "Log-normal AFT model (with random effects)")
