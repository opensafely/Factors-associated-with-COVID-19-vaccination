...
## Summary
The objective of this research was to compare the performance of PH and AFT models in analysing the factors affecting receiving the COVID vaccination. This anlysis was limited to four AFT models which were based on
...
showed that the covariates such as age, ethnicity, imd and sheilding staus were
among factors affecting reciving the COVID vaccination. 
