...
## Import models data
coxmod <- read_rds(here::here("output", "models", "testing", "mod_strat_coxph_adj.rds"))
```
...
Associations between patient-level factors and covid vaccination are shown in the Figure 1 below (also shown in table format at end of document).

```{r, echo = FALSE, warning= FALSE, message= FALSE, fig.width = 12, fig.height = 16, fig.cap="Figure 1: Estimated Hazard Ratios for each potential factor from a stratified Cox model"}
...
* Increasing age was strongly associated with being vaccinated, with those in the 95+ years age group being over twice as likely to be vaccinated compared with those aged 70-74 years

* Males vs females

* All non-white ethnic groups had higher risk than those with white ethnicity: HRs (adjusted for all included risk factors) ranged from 1.83-2.17 for Black, Asian/Asian British and mixed ethnicities compared to white

* Increasing risks were seen with increasing levels of deprivation

* Most comorbidities were associated with higher risk , including diabetes, asthma (with a greater HR for those with recent use of an oral corticosteroid), respiratory disease, chronic heart disease, liver disease, stroke/dementia, other neurological diseases, reduced kidney function, autoimmune diseases (rheumatoid arthritis, lupus or psoriasis) and other immunosuppressive conditions, as per Table 2. 
