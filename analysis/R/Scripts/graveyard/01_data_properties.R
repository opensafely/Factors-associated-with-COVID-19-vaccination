...
if(Sys.getenv("OPENSAFELY_BACKEND") %in% c("", "expectations")){
  for(backend in c("tpp", "emis")){
    ...
    rds_file <- "output/data/data_modelling.rds"
    output_dir <- paste("output/", {backend}, "/data_properties", sep = "")
  ...
  ## Import command-line arguments
  rds_file <- "output/data/data_modelling.rds"
  output_dir <- paste("output/", Sys.getenv('OPENSAFELY_BACKEND'), "/data_properties", sep = "")
